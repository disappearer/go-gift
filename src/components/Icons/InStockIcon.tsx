...
const InStockIcon: React.FC<Props> = ({ style }) => {
  return (
    <Svg
    ...
    >
      <G fill="none" fillRule="evenodd">
        ...
        <Path
          fill="#FFF"
          fillRule="nonzero"
          d="M14.146 10.646a.501.501 0 01.765.638l-.057.07-2.353 2.352-1.354-1.348a.5.5 0 01.637-.767l.069.058.646.644 1.647-1.647z"
        />
      </G>
    </Svg>
  );
